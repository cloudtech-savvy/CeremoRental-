    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              Ceremo <span className="ft-sign">+</span>
            </p>
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="#services">Birthday Party Rentals</a>
            </li>
            <li>
              <a href="#services">Conference Rentals</a>
            </li>
            <li>
              <a href="#services">Wedding Rentals</a>
            </li>
            <li>
              <a href="#services">Workshop or Training</a>
            </li>
            <li>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="ceremony@rental.com">ceremony@rental.com</a>
            </li>
            <li>
              <a href="ceremony@rental.com">
                ceremony@rental.com
              </a>
            </li>
            <li>
              <a href="+91 9638002082">+91 9638002082</a>
            </li>
            <li>
              <a href="+250785254675">+250785254675</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/patrick2016/"
              title="LinkedIn"
              target="_blank"
